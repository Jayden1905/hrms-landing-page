...
const mobileView = `
    <div class="mt-32 h-full md:hidden flex flex-col md:flex-row gap-6 mb-6">
        ...
        <div class="hero-section content flex flex-col w-full items-start gap-6">
            ...
            <p class="font-light leading-[2rem] tracking-wide text-justify">
                ${heroSlogan}
            </p>
...
customElements.define('hero-layout', HeroLayout)
